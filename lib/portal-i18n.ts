...
export const UI: Record<string, Tr> = {
  ...
  "s0.fijadoAviso": { es: "Tu gestoría ya ha elegido esto para ti: viene marcado y no se puede quitar. Puedes añadir lo que quieras.", en: "Your advisor has already chosen this for you: it is ticked and cannot be removed. You can add anything else you need.", fr: "Votre gestionnaire a déjà choisi ceci pour vous : c'est coché et non modifiable. Vous pouvez ajouter ce que vous voulez.", it: "Il tuo consulente ha già scelto questo per te: è selezionato e non si può togliere. Puoi aggiungere quello che vuoi.", de: "Deine Beratung hat das bereits für dich ausgewählt: Es ist markiert und kann nicht entfernt werden. Du kannst weitere Leistungen hinzufügen.", ar: "اختار مكتبك هذا لك: إنه محدد ولا يمكن إزالته. يمكنك إضافة ما تريد.", ro: "Consultantul tău a ales deja acest lucru pentru tine: este bifat și nu poate fi eliminat. Poți adăuga ce dorești.", zh: "您的顾问已为您选择：已勾选且无法取消。您可以再添加其他服务。" },
