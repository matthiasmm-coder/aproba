...
export const UI: Record<string, Tr> = {
  ...
  "prop.nota": { es: "No se te cobrará nada hasta que aceptes. Si aceptas, recibirás la factura del anticipo y podrás subir tus documentos.", en: "You will not be charged anything until you accept. If you accept, you will receive the deposit invoice and will be able to upload your documents.", fr: "Rien ne te sera facturé avant que tu acceptes. Si tu acceptes, tu recevras la facture d'acompte et tu pourras envoyer tes documents.", it: "Non ti verrà addebitato nulla finché non accetti. Se accetti, riceverai la fattura dell'acconto e potrai caricare i tuoi documenti.", de: "Dir wird nichts berechnet, bevor du annimmst. Wenn du annimmst, erhältst du die Anzahlungsrechnung und kannst deine Dokumente hochladen.", ar: "لن يتم تحصيل أي مبلغ منك حتى تقبل. إذا قبلت، ستتلقى فاتورة الدفعة المقدمة ويمكنك رفع مستنداتك.", ro: "Nu ți se va percepe nimic până nu accepți. Dacă accepți, vei primi factura pentru avans și vei putea încărca documentele.", zh: "在你接受之前不会收取任何费用。接受后，你将收到预付款发票并可以上传文件。" },
