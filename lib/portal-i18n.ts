...
export const UI: Record<string, Tr> = {
  ...
  // Chip de UNA solicitud (singular) — «esp.terminados» es el título de la sección (plural).
  "esp.chipTerminado": { es: "Terminado", en: "Completed", fr: "Terminée", it: "Conclusa", de: "Abgeschlossen", ar: "منتهية", ro: "Finalizat", zh: "已完成" },
  ...
  "prop.titulo": { es: "Propuesta de renovación", en: "Renewal proposal", fr: "Proposition de renouvellement", it: "Proposta di rinnovo", de: "Verlängerungsangebot", ar: "اقتراح تجديد", ro: "Propunere de reînnoire", zh: "续期建议" },
  "prop.caduca": { es: "Tu {tipo} caduca el {fecha}.", en: "Your {tipo} expires on {fecha}.", fr: "Ta {tipo} expire le {fecha}.", it: "La tua {tipo} scade il {fecha}.", de: "Deine {tipo} läuft am {fecha} ab.", ar: "تنتهي صلاحية {tipo} الخاصة بك في {fecha}.", ro: "{tipo} ta expiră pe {fecha}.", zh: "你的{tipo}将于{fecha}到期。" },
  "prop.intro": { es: "{gestoria} te propone encargarse de la renovación:", en: "{gestoria} offers to take care of the renewal:", fr: "{gestoria} te propose de s'occuper du renouvellement :", it: "{gestoria} ti propone di occuparsi del rinnovo:", de: "{gestoria} bietet an, die Verlängerung zu übernehmen:", ar: "يقترح {gestoria} تولّي التجديد:", ro: "{gestoria} îți propune să se ocupe de reînnoire:", zh: "{gestoria}建议为你办理续期：" },
  "prop.tramite": { es: "Trámite", en: "Procedure", fr: "Démarche", it: "Pratica", de: "Verfahren", ar: "الإجراء", ro: "Procedură", zh: "手续" },
  "prop.honorarios": { es: "Honorarios (IVA incluido)", en: "Fees (VAT included)", fr: "Honoraires (TVA incluse)", it: "Onorari (IVA inclusa)", de: "Honorar (inkl. MwSt.)", ar: "الأتعاب (شاملة الضريبة)", ro: "Onorarii (TVA inclus)", zh: "费用（含增值税）" },
  "prop.anticipo": { es: "Anticipo para empezar", en: "Deposit to get started", fr: "Acompte pour démarrer", it: "Acconto per iniziare", de: "Anzahlung zum Start", ar: "دفعة مقدمة للبدء", ro: "Avans pentru început", zh: "启动预付款" },
  "prop.sinPrecio": { es: "Precio a consultar", en: "Price on request", fr: "Prix sur demande", it: "Prezzo su richiesta", de: "Preis auf Anfrage", ar: "السعر عند الطلب", ro: "Preț la cerere", zh: "价格面议" },
  "prop.nota": { es: "No se te cobrará nada hasta que aceptes. Si aceptas, revisarás tus datos, subirás tus documentos y abonarás el anticipo al final, como en cualquier trámite.", en: "You will not be charged anything until you accept. If you accept, you will check your details, upload your documents and pay the deposit at the end, like for any procedure.", fr: "Rien ne te sera facturé avant que tu acceptes. Si tu acceptes, tu vérifieras tes informations, enverras tes documents et régleras l'acompte à la fin, comme pour toute démarche.", it: "Non ti verrà addebitato nulla finché non accetti. Se accetti, controllerai i tuoi dati, caricherai i documenti e pagherai l'acconto alla fine, come per qualsiasi pratica.", de: "Dir wird nichts berechnet, bevor du annimmst. Wenn du annimmst, prüfst du deine Daten, lädst deine Dokumente hoch und zahlst die Anzahlung am Ende – wie bei jedem Verfahren.", ar: "لن يتم تحصيل أي مبلغ منك حتى تقبل. إذا قبلت، ستراجع بياناتك وترفع مستنداتك وتدفع الدفعة المقدمة في النهاية، كما في أي إجراء.", ro: "Nu ți se va percepe nimic până nu accepți. Dacă accepți, îți vei verifica datele, vei încărca documentele și vei plăti avansul la final, ca la orice procedură.", zh: "在你接受之前不会收取任何费用。接受后，你将核对信息、上传文件，并在最后支付预付款，与任何手续一样。" },
  "prop.aceptar": { es: "Aceptar la renovación", en: "Accept the renewal", fr: "Accepter le renouvellement", it: "Accetta il rinnovo", de: "Verlängerung annehmen", ar: "قبول التجديد", ro: "Accept reînnoirea", zh: "接受续期" },
  "prop.rechazar": { es: "No quiero renovar", en: "I don't want to renew", fr: "Je ne veux pas renouveler", it: "Non voglio rinnovare", de: "Ich möchte nicht verlängern", ar: "لا أريد التجديد", ro: "Nu vreau să reînnoiesc", zh: "我不想续期" },
  "prop.confirmarRechazo": { es: "¿Seguro que no quieres que {gestoria} se encargue de la renovación?", en: "Are you sure you don't want {gestoria} to handle the renewal?", fr: "Es-tu sûr de ne pas vouloir que {gestoria} s'occupe du renouvellement ?", it: "Sei sicuro di non volere che {gestoria} si occupi del rinnovo?", de: "Bist du sicher, dass {gestoria} die Verlängerung nicht übernehmen soll?", ar: "هل أنت متأكد أنك لا تريد أن يتولى {gestoria} التجديد؟", ro: "Sigur nu vrei ca {gestoria} să se ocupe de reînnoire?", zh: "你确定不需要{gestoria}办理续期吗？" },
  "prop.enviando": { es: "Enviando…", en: "Sending…", fr: "Envoi…", it: "Invio…", de: "Wird gesendet…", ar: "جارٍ الإرسال…", ro: "Se trimite…", zh: "发送中…" },
  "prop.aceptada": { es: "¡Perfecto! Preparamos tu renovación…", en: "Great! We're preparing your renewal…", fr: "Parfait ! Nous préparons ton renouvellement…", it: "Perfetto! Prepariamo il tuo rinnovo…", de: "Super! Wir bereiten deine Verlängerung vor…", ar: "رائع! نجهّز تجديدك…", ro: "Perfect! Pregătim reînnoirea ta…", zh: "太好了！我们正在准备你的续期……" },
  "prop.rechazada": { es: "Has rechazado la renovación. Si cambias de opinión, escribe a {gestoria}.", en: "You have declined the renewal. If you change your mind, contact {gestoria}.", fr: "Tu as refusé le renouvellement. Si tu changes d'avis, écris à {gestoria}.", it: "Hai rifiutato il rinnovo. Se cambi idea, scrivi a {gestoria}.", de: "Du hast die Verlängerung abgelehnt. Wenn du es dir anders überlegst, schreib an {gestoria}.", ar: "لقد رفضت التجديد. إذا غيّرت رأيك، تواصل مع {gestoria}.", ro: "Ai refuzat reînnoirea. Dacă te răzgândești, scrie-i lui {gestoria}.", zh: "你已拒绝续期。如果改变主意，请联系{gestoria}。" },
  "prop.error": { es: "No se ha podido registrar tu respuesta. Inténtalo de nuevo.", en: "Your answer could not be saved. Please try again.", fr: "Ta réponse n'a pas pu être enregistrée. Réessaie.", it: "Non è stato possibile registrare la tua risposta. Riprova.", de: "Deine Antwort konnte nicht gespeichert werden. Bitte versuche es erneut.", ar: "تعذّر تسجيل إجابتك. حاول مرة أخرى.", ro: "Răspunsul tău nu a putut fi înregistrat. Încearcă din nou.", zh: "无法保存你的回复，请重试。" },
  "esp.docTitulo": { es: "Documentos que te pedimos", en: "Documents we need from you", fr: "Documents que nous te demandons", it: "Documenti che ti chiediamo", de: "Dokumente, die wir von dir brauchen", ar: "المستندات المطلوبة منك", ro: "Documente pe care ți le cerem", zh: "我们需要你提供的文件" },
  "esp.docCaduca": { es: "Tu {documento} caduca el {fecha}: súbenos el nuevo (foto o PDF).", en: "Your {documento} expires on {fecha}: upload the new one (photo or PDF).", fr: "Ton {documento} expire le {fecha} : envoie-nous le nouveau (photo ou PDF).", it: "Il tuo {documento} scade il {fecha}: carica quello nuovo (foto o PDF).", de: "Dein {documento} läuft am {fecha} ab: lade den neuen hoch (Foto oder PDF).", ar: "تنتهي صلاحية {documento} الخاص بك في {fecha}: ارفع الجديد (صورة أو PDF).", ro: "{documento} tău expiră pe {fecha}: încarcă-l pe cel nou (foto sau PDF).", zh: "你的{documento}将于{fecha}到期：请上传新的（照片或PDF）。" },
  "esp.docSubir": { es: "Subir", en: "Upload", fr: "Envoyer", it: "Carica", de: "Hochladen", ar: "رفع", ro: "Încarcă", zh: "上传" },
  "esp.docSubiendo": { es: "Subiendo…", en: "Uploading…", fr: "Envoi…", it: "Caricamento…", de: "Wird hochgeladen…", ar: "جارٍ الرفع…", ro: "Se încarcă…", zh: "上传中…" },
  "esp.docOk": { es: "¡Recibido! Válido hasta el {fecha}.", en: "Received! Valid until {fecha}.", fr: "Reçu ! Valable jusqu'au {fecha}.", it: "Ricevuto! Valido fino al {fecha}.", de: "Erhalten! Gültig bis {fecha}.", ar: "تم الاستلام! صالح حتى {fecha}.", ro: "Primit! Valabil până la {fecha}.", zh: "已收到！有效期至{fecha}。" },
  "esp.docOkRevisar": { es: "Recibido. Tu gestoría lo revisará.", en: "Received. Your advisor will review it.", fr: "Reçu. Ton cabinet va le vérifier.", it: "Ricevuto. Il tuo studio lo verificherà.", de: "Erhalten. Deine Kanzlei prüft es.", ar: "تم الاستلام. سيراجعه مكتبك.", ro: "Primit. Biroul tău îl va verifica.", zh: "已收到。你的顾问将进行审核。" },
  "esp.docError": { es: "No se ha podido subir. Inténtalo de nuevo.", en: "Upload failed. Please try again.", fr: "L'envoi a échoué. Réessaie.", it: "Caricamento non riuscito. Riprova.", de: "Hochladen fehlgeschlagen. Bitte erneut versuchen.", ar: "تعذّر الرفع. حاول مرة أخرى.", ro: "Încărcarea a eșuat. Încearcă din nou.", zh: "上传失败，请重试。" },
  "esp.docFormato": { es: "JPG, PNG, WebP o PDF · máx. 8 MB", en: "JPG, PNG, WebP or PDF · max. 8 MB", fr: "JPG, PNG, WebP ou PDF · 8 Mo max.", it: "JPG, PNG, WebP o PDF · max 8 MB", de: "JPG, PNG, WebP oder PDF · max. 8 MB", ar: "JPG أو PNG أو WebP أو PDF · بحد أقصى 8 ميغابايت", ro: "JPG, PNG, WebP sau PDF · max. 8 MB", zh: "JPG、PNG、WebP 或 PDF · 最大 8 MB" },
  "prop.dudas": { es: "¿Tienes dudas? Escribe o llama a {gestoria}:", en: "Any questions? Write to or call {gestoria}:", fr: "Des questions ? Écris ou appelle {gestoria} :", it: "Hai dubbi? Scrivi o chiama {gestoria}:", de: "Fragen? Schreib an oder ruf {gestoria} an:", ar: "هل لديك أسئلة؟ راسل {gestoria} أو اتصل به:", ro: "Ai întrebări? Scrie-i sau sună la {gestoria}:", zh: "有疑问？请联系{gestoria}：" },
  "prop.registrando": { es: "Registrando tu respuesta…", en: "Saving your answer…", fr: "Enregistrement de ta réponse…", it: "Registrazione della tua risposta…", de: "Deine Antwort wird gespeichert…", ar: "جارٍ تسجيل إجابتك…", ro: "Se înregistrează răspunsul tău…", zh: "正在记录你的回复……" },
  "s0.fijadoBadge": { es: "Lo pide tu gestoría", en: "Set by your advisor", fr: "Demandé par votre gestionnaire", it: "Richiesto dal tuo consulente", de: "Von deiner Beratung festgelegt", ar: "مطلوب من مكتبك", ro: "Cerut de consultantul tău", zh: "由您的顾问设定" },
  "s0.fijadoAviso": { es: "Lo marcado lo ha elegido tu gestoría y no se puede quitar. Puedes añadir más.", en: "The ticked items were chosen by your advisor and cannot be removed. You can add more.", fr: "Ce qui est coché vient de votre gestionnaire et ne peut pas être retiré. Vous pouvez en ajouter.", it: "Ciò che è selezionato lo ha scelto il tuo consulente e non si può togliere. Puoi aggiungerne altri.", de: "Das Angekreuzte hat deine Beratung gewählt und kann nicht entfernt werden. Du kannst weitere hinzufügen.", ar: "ما هو محدَّد اختاره مكتبك ولا يمكن إزالته. يمكنك إضافة المزيد.", ro: "Ce este bifat a fost ales de consultantul tău și nu poate fi eliminat. Poți adăuga altele.", zh: "已勾选的项目由您的顾问选定，无法取消。您可以再添加。" },
  "s0.fijado": { es: "Tu gestoría ya ha fijado el trámite de esta renovación. Solo tienes que revisar tus datos y subir los documentos.", en: "Your advisor has already set the procedure for this renewal. You just need to check your details and upload the documents.", fr: "Ton cabinet a déjà fixé la démarche de ce renouvellement. Il ne te reste qu'à vérifier tes informations et envoyer les documents.", it: "Il tuo studio ha già fissato la pratica di questo rinnovo. Devi solo controllare i tuoi dati e caricare i documenti.", de: "Deine Kanzlei hat das Verfahren für diese Verlängerung bereits festgelegt. Du musst nur deine Daten prüfen und die Dokumente hochladen.", ar: "حدد مكتبك بالفعل إجراء هذا التجديد. ما عليك سوى مراجعة بياناتك ورفع المستندات.", ro: "Biroul tău a stabilit deja procedura acestei reînnoiri. Trebuie doar să-ți verifici datele și să încarci documentele.", zh: "你的顾问已确定本次续期的手续。你只需核对信息并上传文件。" },
  ...
  "s2.lote.titulo": { es: "¿Los tienes todos a mano? Súbelos de una vez", en: "Got them all? Upload everything at once", fr: "Vous avez tout sous la main ? Envoyez tout d'un coup", it: "Li hai tutti? Caricali in una volta", de: "Alles zur Hand? Alles auf einmal hochladen" },
  "s2.lote.desc": { es: "Elige varios archivos: reconocemos cada documento y lo colocamos en su casilla.", en: "Pick several files: we recognise each document and place it in its slot.", fr: "Choisissez plusieurs fichiers : nous reconnaissons chaque document et le rangeons à sa place.", it: "Scegli più file: riconosciamo ogni documento e lo mettiamo nella sua casella.", de: "Mehrere Dateien wählen: Wir erkennen jedes Dokument und ordnen es richtig zu." },
  "s2.lote.boton": { es: "Subir varios a la vez", en: "Upload several at once", fr: "Envoyer plusieurs fichiers", it: "Carica più file", de: "Mehrere hochladen" },
  "s2.lote.noReconocido": { es: "No lo hemos reconocido — súbelo abajo en su casilla.", en: "We couldn't recognise it — upload it below in its slot.", fr: "Document non reconnu — envoyez-le ci-dessous dans sa case.", it: "Non riconosciuto — caricalo qui sotto nella sua casella.", de: "Nicht erkannt — bitte unten im passenden Feld hochladen." },
  "s2.lote.aparte": {
    es: "Guardado como {doc} (no lo pedía este trámite, pero tu gestoría lo verá).",
    en: "Saved as {doc} (not required for this procedure, but your firm will see it).",
    fr: "Enregistré comme {doc} (non demandé pour cette démarche, mais votre cabinet le verra).",
    it: "Salvato come {doc} (non richiesto per questa pratica, ma il tuo studio lo vedrà).",
    de: "Als {doc} gespeichert (für dieses Verfahren nicht verlangt, Ihre Kanzlei sieht es aber).",
  },
  "s2.otros.titulo": {
    es: "Otros documentos guardados",
    en: "Other saved documents",
    fr: "Autres documents enregistrés",
    it: "Altri documenti salvati",
    de: "Weitere gespeicherte Dokumente",
  },
  "s2.otros.desc": {
    es: "No los pide este trámite, pero los hemos guardado en tu expediente: tu gestoría los tiene.",
    en: "This procedure doesn't ask for them, but we saved them in your file: your firm has them.",
    fr: "Cette démarche ne les demande pas, mais nous les avons enregistrés dans votre dossier : votre cabinet les a.",
    it: "Questa pratica non li richiede, ma li abbiamo salvati nel tuo fascicolo: il tuo studio li ha.",
    de: "Dieses Verfahren verlangt sie nicht, aber wir haben sie in Ihrer Akte gespeichert: Ihre Kanzlei hat sie.",
  },
  ...
  // Cliente-EMPRESA: cada documento lo firma quien debe — la hoja la empresa (contrata
  // y paga), el mandato el trabajador (es a quien se representa). 18/09/2026.
  "firma.introEmpresa": { es: "La hoja de encargo la firma tu empresa ({empresa}): descárgala y pásasela. El mandato lo firmas tú. Sube los dos aquí abajo, firmados.", en: "The engagement letter is signed by your company ({empresa}): download it and pass it on. You sign the power of representation yourself. Upload both here, signed.", fr: "La lettre de mission est signée par votre entreprise ({empresa}) : téléchargez-la et transmettez-la. Le mandat, c'est vous qui le signez. Déposez les deux ici, signés.", it: "La lettera d'incarico la firma la tua azienda ({empresa}): scaricala e passagliela. Il mandato lo firmi tu. Carica qui entrambi, firmati.", de: "Das Auftragsblatt unterschreibt dein Unternehmen ({empresa}): lade es herunter und gib es weiter. Die Vollmacht unterschreibst du selbst. Lade beide hier unterschrieben hoch.", ar: "خطاب التكليف توقّعه شركتك ({empresa}): نزّله وسلّمه لها. أما التفويض فتوقّعه أنت. ارفع كليهما هنا موقّعَين.", ro: "Scrisoarea de misiune o semnează firma ta ({empresa}): descarc-o și dă-i-o. Mandatul îl semnezi tu. Încarcă-le pe amândouă aici, semnate.", zh: "委托书由你的公司（{empresa}）签署：下载后转交给公司。授权书由你本人签署。两份签好后都上传到下方。" },
  "firma.hojaEmpresa": { es: "Hoja de encargo (la firma la empresa)", en: "Engagement letter (signed by the company)", fr: "Lettre de mission (signée par l'entreprise)", it: "Lettera d'incarico (la firma l'azienda)", de: "Auftragsblatt (vom Unternehmen unterschrieben)", ar: "خطاب التكليف (توقّعه الشركة)", ro: "Scrisoare de misiune (o semnează firma)", zh: "委托书（由公司签署）" },
  "firma.mandatoTuyo": { es: "Mandato de representación (lo firmas tú)", en: "Power of representation (you sign it)", fr: "Mandat de représentation (c'est vous qui signez)", it: "Mandato di rappresentanza (lo firmi tu)", de: "Vertretungsvollmacht (du unterschreibst)", ar: "تفويض التمثيل (توقّعه أنت)", ro: "Mandat de reprezentare (îl semnezi tu)", zh: "代理授权书（由你本人签署）" },
  ...
  "notif.renov.anticipo": {
    es: "Anticipo para empezar: {importe} (se abona al completar tu expediente).",
    en: "Deposit to get started: {importe} (paid once you complete your file).",
    fr: "Acompte pour démarrer : {importe} (réglé une fois ton dossier complété).",
    it: "Acconto per iniziare: {importe} (si paga al completamento della pratica).",
    de: "Anzahlung zum Start: {importe} (fällig, sobald du deine Akte vervollständigt hast).",
  },
  ...
  "notif.prop.subject": { es: "Propuesta de renovación · {gestoria}", en: "Renewal proposal · {gestoria}", fr: "Proposition de renouvellement · {gestoria}", it: "Proposta di rinnovo · {gestoria}", de: "Verlängerungsangebot · {gestoria}" },
  "notif.prop.titulo": { es: "Propuesta de renovación: {servicio}", en: "Renewal proposal: {servicio}", fr: "Proposition de renouvellement : {servicio}", it: "Proposta di rinnovo: {servicio}", de: "Verlängerungsangebot: {servicio}" },
  "notif.prop.body": {
    es: "Hola {nombre}, tu {tipo} caduca el {fecha}. {gestoria} te propone encargarse de la renovación. Revisa el trámite y el precio y dinos si quieres seguir adelante.",
    en: "Hi {nombre}, your {tipo} expires on {fecha}. {gestoria} offers to take care of the renewal. Check the procedure and the price and let us know if you want to go ahead.",
    fr: "Bonjour {nombre}, ta {tipo} expire le {fecha}. {gestoria} te propose de s'occuper du renouvellement. Vérifie la démarche et le prix et dis-nous si tu veux continuer.",
    it: "Ciao {nombre}, la tua {tipo} scade il {fecha}. {gestoria} ti propone di occuparsi del rinnovo. Controlla la pratica e il prezzo e dicci se vuoi procedere.",
    de: "Hallo {nombre}, deine {tipo} läuft am {fecha} ab. {gestoria} bietet an, die Verlängerung zu übernehmen. Prüfe Verfahren und Preis und sag uns, ob du fortfahren möchtest.",
  },
  "notif.prop.bodySinFecha": {
    es: "Hola {nombre}, tu {tipo} caduca pronto. {gestoria} te propone encargarse de la renovación. Revisa el trámite y el precio y dinos si quieres seguir adelante.",
    en: "Hi {nombre}, your {tipo} expires soon. {gestoria} offers to take care of the renewal. Check the procedure and the price and let us know if you want to go ahead.",
    fr: "Bonjour {nombre}, ta {tipo} expire bientôt. {gestoria} te propose de s'occuper du renouvellement. Vérifie la démarche et le prix et dis-nous si tu veux continuer.",
    it: "Ciao {nombre}, la tua {tipo} scade presto. {gestoria} ti propone di occuparsi del rinnovo. Controlla la pratica e il prezzo e dicci se vuoi procedere.",
    de: "Hallo {nombre}, deine {tipo} läuft bald ab. {gestoria} bietet an, die Verlängerung zu übernehmen. Prüfe Verfahren und Preis und sag uns, ob du fortfahren möchtest.",
  },
  "notif.prop.aceptar": { es: "Aceptar la renovación", en: "Accept the renewal", fr: "Accepter le renouvellement", it: "Accetta il rinnovo", de: "Verlängerung annehmen" },
  "notif.prop.rechazar": { es: "No, gracias", en: "No, thanks", fr: "Non, merci", it: "No, grazie", de: "Nein, danke" },
  "notif.prop.nota": { es: "No se te cobrará nada hasta que aceptes.", en: "You will not be charged anything until you accept.", fr: "Rien ne te sera facturé avant que tu acceptes.", it: "Non ti verrà addebitato nulla finché non accetti.", de: "Dir wird nichts berechnet, bevor du annimmst." },
  "notif.doc.subject": { es: "Necesitamos tu {documento} renovado · {gestoria}", en: "We need your renewed {documento} · {gestoria}", fr: "Nous avons besoin de ton nouveau {documento} · {gestoria}", it: "Ci serve il tuo {documento} rinnovato · {gestoria}", de: "Wir brauchen deinen neuen {documento} · {gestoria}" },
  "notif.doc.titulo": { es: "Tu {documento} caduca", en: "Your {documento} is expiring", fr: "Ton {documento} expire", it: "Il tuo {documento} sta per scadere", de: "Dein {documento} läuft ab" },
  "notif.doc.body": {
    es: "Hola {nombre}, tu {documento} caduca el {fecha}. Cuando tengas el nuevo, súbenos una foto o el PDF: {gestoria} lo necesita para seguir con tus trámites.",
    en: "Hi {nombre}, your {documento} expires on {fecha}. Once you have the new one, upload a photo or the PDF: {gestoria} needs it to continue with your applications.",
    fr: "Bonjour {nombre}, ton {documento} expire le {fecha}. Dès que tu as le nouveau, envoie-nous une photo ou le PDF : {gestoria} en a besoin pour poursuivre tes démarches.",
    it: "Ciao {nombre}, il tuo {documento} scade il {fecha}. Quando avrai quello nuovo, caricane una foto o il PDF: {gestoria} ne ha bisogno per proseguire con le tue pratiche.",
    de: "Hallo {nombre}, dein {documento} läuft am {fecha} ab. Sobald du den neuen hast, lade ein Foto oder das PDF hoch: {gestoria} braucht ihn für deine Verfahren.",
  },
  "notif.doc.bodySinFecha": {
    es: "Hola {nombre}, tu {documento} caduca pronto. Cuando tengas el nuevo, súbenos una foto o el PDF: {gestoria} lo necesita para seguir con tus trámites.",
    en: "Hi {nombre}, your {documento} expires soon. Once you have the new one, upload a photo or the PDF: {gestoria} needs it to continue with your applications.",
    fr: "Bonjour {nombre}, ton {documento} expire bientôt. Dès que tu as le nouveau, envoie-nous une photo ou le PDF : {gestoria} en a besoin pour poursuivre tes démarches.",
    it: "Ciao {nombre}, il tuo {documento} scade presto. Quando avrai quello nuovo, caricane una foto o il PDF: {gestoria} ne ha bisogno per proseguire con le tue pratiche.",
    de: "Hallo {nombre}, dein {documento} läuft bald ab. Sobald du den neuen hast, lade ein Foto oder das PDF hoch: {gestoria} braucht ihn für deine Verfahren.",
  },
  ...
  "wa.recibidoPendiente": { es: "Hemos recibido tu documento. Lo estamos revisando y tu gestoría te confirmará en breve.", en: "We've received your document. We're reviewing it and your office will confirm shortly.", fr: "Nous avons bien reçu votre document. Nous le vérifions et votre cabinet vous confirmera sous peu.", it: "Abbiamo ricevuto il tuo documento. Lo stiamo verificando e il tuo studio ti confermerà a breve.", de: "Wir haben Ihr Dokument erhalten. Wir prüfen es und Ihre Kanzlei bestätigt Ihnen in Kürze.", ar: "لقد استلمنا وثيقتك. نحن نراجعها وسيؤكد لك مكتبك قريبًا.", ro: "Am primit documentul tău. Îl verificăm și biroul tău îți va confirma în scurt timp.", zh: "我们已收到你的文件。正在核对，你的事务所会尽快确认。" },
  ...
  // ── Expediente DE EMPRESA (21/09/2026): la empresa completa sus datos y los de sus trabajadores ──
  "emp.step.datos": { es: "Empresa y trabajadores", en: "Company & workers", fr: "Entreprise et travailleurs", it: "Azienda e lavoratori", de: "Unternehmen & Arbeitnehmer", ar: "الشركة والعمّال", ro: "Companie și lucrători", zh: "公司与员工" },
  "emp.datos.titulo": { es: "Datos de la empresa y de sus trabajadores", en: "Company and workers' details", fr: "Données de l'entreprise et de ses travailleurs", it: "Dati dell'azienda e dei suoi lavoratori", de: "Angaben zum Unternehmen und seinen Arbeitnehmern", ar: "بيانات الشركة وعمّالها", ro: "Datele companiei și ale lucrătorilor săi", zh: "公司及其员工资料" },
  "emp.datos.intro": { es: "Completa los datos de la empresa (van en la hoja de encargo y en las facturas) y añade a cada trabajador con su ficha.", en: "Fill in the company details (they go on the engagement letter and invoices) and add each worker with their details.", fr: "Complétez les données de l'entreprise (elles figurent sur la lettre de mission et les factures) et ajoutez chaque travailleur avec sa fiche.", it: "Completa i dati dell'azienda (compaiono nella lettera d'incarico e nelle fatture) e aggiungi ogni lavoratore con la sua scheda.", de: "Ergänzen Sie die Unternehmensdaten (sie stehen im Auftragsschreiben und auf den Rechnungen) und fügen Sie jeden Arbeitnehmer mit seinen Angaben hinzu.", ar: "أكمل بيانات الشركة (تظهر في خطاب التكليف والفواتير) وأضف كل عامل مع بياناته.", ro: "Completează datele companiei (apar pe fișa de angajament și pe facturi) și adaugă fiecare lucrător cu datele sale.", zh: "填写公司资料（用于委托书和发票），并逐一添加员工及其资料。" },
  "emp.seccion.empresa": { es: "Tu empresa", en: "Your company", fr: "Votre entreprise", it: "La tua azienda", de: "Ihr Unternehmen", ar: "شركتك", ro: "Compania ta", zh: "贵公司" },
  "emp.seccion.trabajadores": { es: "Trabajadores", en: "Workers", fr: "Travailleurs", it: "Lavoratori", de: "Arbeitnehmer", ar: "العمّال", ro: "Lucrători", zh: "员工" },
  "emp.trabajadoresHint": { es: "Cada trabajador tendrá sus documentos, sus formularios y su propio mandato. Puedes añadir más después.", en: "Each worker will have their own documents, forms and power of representation. You can add more later.", fr: "Chaque travailleur aura ses documents, ses formulaires et son propre mandat. Vous pourrez en ajouter d'autres plus tard.", it: "Ogni lavoratore avrà i suoi documenti, i suoi moduli e il suo mandato. Potrai aggiungerne altri in seguito.", de: "Jeder Arbeitnehmer hat eigene Dokumente, Formulare und eine eigene Vollmacht. Sie können später weitere hinzufügen.", ar: "لكل عامل وثائقه ونماذجه وتوكيله الخاص. يمكنك إضافة المزيد لاحقًا.", ro: "Fiecare lucrător va avea documentele, formularele și mandatul său. Poți adăuga alții mai târziu.", zh: "每位员工都有自己的文件、表格和授权书。之后还可以继续添加。" },
  "emp.razonSocial": { es: "Razón social", en: "Company name", fr: "Raison sociale", it: "Ragione sociale", de: "Firmenname", ar: "الاسم القانوني للشركة", ro: "Denumirea companiei", zh: "公司名称" },
  "emp.nif": { es: "CIF / NIF", en: "CIF / NIF", fr: "CIF / NIF", it: "CIF / NIF", de: "CIF / NIF", ar: "CIF / NIF", ro: "CIF / NIF", zh: "CIF / NIF" },
  "emp.domicilio": { es: "Domicilio fiscal", en: "Registered address", fr: "Adresse fiscale", it: "Sede fiscale", de: "Geschäftsadresse", ar: "العنوان الضريبي", ro: "Sediul fiscal", zh: "注册地址" },
  "emp.codigoPostal": { es: "Código postal", en: "Postcode", fr: "Code postal", it: "CAP", de: "Postleitzahl", ar: "الرمز البريدي", ro: "Cod poștal", zh: "邮政编码" },
  "emp.municipio": { es: "Municipio", en: "City", fr: "Commune", it: "Comune", de: "Ort", ar: "البلدية", ro: "Localitate", zh: "城市" },
  "emp.provincia": { es: "Provincia", en: "Province", fr: "Province", it: "Provincia", de: "Provinz", ar: "المقاطعة", ro: "Provincie", zh: "省份" },
  "emp.contactoNombre": { es: "Persona de contacto", en: "Contact person", fr: "Personne de contact", it: "Persona di contatto", de: "Ansprechpartner", ar: "شخص الاتصال", ro: "Persoană de contact", zh: "联系人" },
  "emp.contactoEmail": { es: "Email de contacto", en: "Contact email", fr: "Email de contact", it: "Email di contatto", de: "Kontakt-E-Mail", ar: "البريد الإلكتروني للتواصل", ro: "Email de contact", zh: "联系邮箱" },
  "emp.contactoTelefono": { es: "Teléfono de contacto", en: "Contact phone", fr: "Téléphone de contact", it: "Telefono di contatto", de: "Kontakttelefon", ar: "هاتف الاتصال", ro: "Telefon de contact", zh: "联系电话" },
  "emp.trabajador": { es: "Trabajador", en: "Worker", fr: "Travailleur", it: "Lavoratore", de: "Arbeitnehmer", ar: "عامل", ro: "Lucrător", zh: "员工" },
  "emp.trabajadorSinNombre": { es: "Nuevo trabajador", en: "New worker", fr: "Nouveau travailleur", it: "Nuovo lavoratore", de: "Neuer Arbeitnehmer", ar: "عامل جديد", ro: "Lucrător nou", zh: "新员工" },
  "emp.anadir": { es: "Añadir trabajador", en: "Add worker", fr: "Ajouter un travailleur", it: "Aggiungi lavoratore", de: "Arbeitnehmer hinzufügen", ar: "إضافة عامل", ro: "Adaugă lucrător", zh: "添加员工" },
  "emp.faltanEmpresa": { es: "Faltan datos de la empresa: {n} campos por rellenar", en: "Company details incomplete: {n} fields left", fr: "Données de l'entreprise incomplètes : {n} champs à remplir", it: "Dati dell'azienda incompleti: {n} campi da compilare", de: "Unternehmensdaten unvollständig: {n} Felder fehlen", ar: "بيانات الشركة غير مكتملة: {n} حقول متبقية", ro: "Datele companiei sunt incomplete: {n} câmpuri de completat", zh: "公司资料不完整：还有 {n} 项待填写" },
  "emp.minUnTrabajador": { es: "Añade al menos un trabajador.", en: "Add at least one worker.", fr: "Ajoutez au moins un travailleur.", it: "Aggiungi almeno un lavoratore.", de: "Fügen Sie mindestens einen Arbeitnehmer hinzu.", ar: "أضف عاملًا واحدًا على الأقل.", ro: "Adaugă cel puțin un lucrător.", zh: "请至少添加一名员工。" },
  "emp.s1.intro": { es: "¿Qué trámite hace cada trabajador?", en: "Which procedure does each worker need?", fr: "Quelle démarche pour chaque travailleur ?", it: "Quale pratica per ogni lavoratore?", de: "Welches Verfahren für jeden Arbeitnehmer?", ar: "ما المعاملة الخاصة بكل عامل؟", ro: "Ce procedură face fiecare lucrător?", zh: "每位员工需要办理哪项手续？" },
  "emp.s0.total": { es: "Total para la empresa", en: "Total for the company", fr: "Total pour l'entreprise", it: "Totale per l'azienda", de: "Gesamt für das Unternehmen", ar: "الإجمالي للشركة", ro: "Total pentru companie", zh: "公司合计" },
  "emp.s0.error": { es: "Elige al menos un trámite para un trabajador.", en: "Choose at least one procedure for one worker.", fr: "Choisissez au moins une démarche pour un travailleur.", it: "Scegli almeno una pratica per un lavoratore.", de: "Wählen Sie mindestens ein Verfahren für einen Arbeitnehmer.", ar: "اختر معاملة واحدة على الأقل لعامل واحد.", ro: "Alege cel puțin o procedură pentru un lucrător.", zh: "请至少为一名员工选择一项手续。" },
  "emp.docs.titulo": { es: "Documentos de los trabajadores", en: "Workers' documents", fr: "Documents des travailleurs", it: "Documenti dei lavoratori", de: "Dokumente der Arbeitnehmer", ar: "وثائق العمّال", ro: "Documentele lucrătorilor", zh: "员工文件" },
  "emp.docs.intro": { es: "Sube los documentos de cada trabajador. Cada uno también podrá subir los suyos desde su propio enlace.", en: "Upload each worker's documents. Each worker can also upload theirs from their own link.", fr: "Téléversez les documents de chaque travailleur. Chacun pourra aussi téléverser les siens depuis son propre lien.", it: "Carica i documenti di ogni lavoratore. Ognuno potrà anche caricare i propri dal suo link.", de: "Laden Sie die Dokumente jedes Arbeitnehmers hoch. Jeder kann seine auch über seinen eigenen Link hochladen.", ar: "ارفع وثائق كل عامل. يمكن لكل عامل أيضًا رفع وثائقه من رابطه الخاص.", ro: "Încarcă documentele fiecărui lucrător. Fiecare le poate încărca și de pe propriul link.", zh: "上传每位员工的文件。每位员工也可以通过自己的链接上传。" },
  "emp.docs.comunes": { es: "Documentos de la empresa", en: "Company documents", fr: "Documents de l'entreprise", it: "Documenti dell'azienda", de: "Unternehmensdokumente", ar: "وثائق الشركة", ro: "Documentele companiei", zh: "公司文件" },
  "emp.docs.comunesHint": { es: "Se suben una sola vez para todo el expediente.", en: "Uploaded once for the whole file.", fr: "À téléverser une seule fois pour tout le dossier.", it: "Si caricano una sola volta per tutta la pratica.", de: "Wird nur einmal für die ganze Akte hochgeladen.", ar: "تُرفع مرة واحدة للملف بأكمله.", ro: "Se încarcă o singură dată pentru întregul dosar.", zh: "整个案卷只需上传一次。" },
  "emp.firma.intro": { es: "La hoja de encargo la firma la empresa: descárgala, fírmala y súbela aquí. El mandato de representación lo firma cada trabajador: lo tienes en su sección.", en: "The engagement letter is signed by the company: download it, sign it and upload it here. The power of representation is signed by each worker: you'll find it in their section.", fr: "La lettre de mission est signée par l'entreprise : téléchargez-la, signez-la et téléversez-la ici. Le mandat de représentation est signé par chaque travailleur : il se trouve dans sa section.", it: "La lettera d'incarico la firma l'azienda: scaricala, firmala e caricala qui. Il mandato di rappresentanza lo firma ogni lavoratore: lo trovi nella sua sezione.", de: "Das Auftragsschreiben unterschreibt das Unternehmen: herunterladen, unterschreiben und hier hochladen. Die Vollmacht unterschreibt jeder Arbeitnehmer: Sie finden sie in seinem Abschnitt.", ar: "خطاب التكليف توقّعه الشركة: حمّله ووقّعه وارفعه هنا. أما التوكيل فيوقّعه كل عامل: تجده في قسمه.", ro: "Fișa de angajament o semnează compania: descarc-o, semneaz-o și încarc-o aici. Mandatul de reprezentare îl semnează fiecare lucrător: îl găsești în secțiunea lui.", zh: "委托书由公司签署：下载、签署后在此上传。授权书由每位员工签署：请在其各自的部分中查看。" },
  "emp.firma.mandatoDe": { es: "Mandato de {nombre} (PDF)", en: "Power of representation for {nombre} (PDF)", fr: "Mandat de {nombre} (PDF)", it: "Mandato di {nombre} (PDF)", de: "Vollmacht von {nombre} (PDF)", ar: "توكيل {nombre} (PDF)", ro: "Mandatul lui {nombre} (PDF)", zh: "{nombre}的授权书 (PDF)" },
  "emp.firma.mandatoHint": { es: "Lo firma el trabajador. Descárgalo, pásaselo y sube aquí el mandato firmado.", en: "Signed by the worker. Download it, hand it over and upload the signed power of representation here.", fr: "Signé par le travailleur. Téléchargez-le, remettez-le-lui et téléversez ici le mandat signé.", it: "Lo firma il lavoratore. Scaricalo, consegnaglielo e carica qui il mandato firmato.", de: "Unterschreibt der Arbeitnehmer. Herunterladen, aushändigen und die unterschriebene Vollmacht hier hochladen.", ar: "يوقّعه العامل. حمّله وسلّمه له وارفع التوكيل الموقّع هنا.", ro: "Îl semnează lucrătorul. Descarcă-l, dă-i-l și încarcă aici mandatul semnat.", zh: "由员工签署。下载后交给员工，再在此上传已签署的授权书。" },
  "emp.s3.xTrabajadores": { es: "{precio} × {n} trabajadores", en: "{precio} × {n} workers", fr: "{precio} × {n} travailleurs", it: "{precio} × {n} lavoratori", de: "{precio} × {n} Arbeitnehmer", ar: "{precio} × {n} عمّال", ro: "{precio} × {n} lucrători", zh: "{precio} × {n} 名员工" },
  "emp.s3.nTrabajadores": { es: "{n} trabajadores", en: "{n} workers", fr: "{n} travailleurs", it: "{n} lavoratori", de: "{n} Arbeitnehmer", ar: "{n} عمّال", ro: "{n} lucrători", zh: "{n} 名员工" },
  // ── Enlace individual del trabajador (/t/<token>, lote 3, 21/09/2026) ──
  "trab.saludo": { es: "Hola, {nombre} 👋", en: "Hello, {nombre} 👋", fr: "Bonjour {nombre} 👋", it: "Ciao, {nombre} 👋", de: "Hallo, {nombre} 👋", ar: "مرحبًا {nombre} 👋", ro: "Bună, {nombre} 👋", zh: "你好，{nombre} 👋" },
  "trab.intro": { es: "{empresa} está tramitando tu expediente con {gestoria}. Aquí subes tus documentos y firmas tu mandato; el resto lo lleva tu empresa.", en: "{empresa} is processing your file with {gestoria}. Here you upload your documents and sign your power of representation; your company handles the rest.", fr: "{empresa} traite votre dossier avec {gestoria}. Ici vous téléversez vos documents et signez votre mandat ; votre entreprise s'occupe du reste.", it: "{empresa} sta gestendo la tua pratica con {gestoria}. Qui carichi i tuoi documenti e firmi il tuo mandato; del resto si occupa la tua azienda.", de: "{empresa} bearbeitet Ihre Akte mit {gestoria}. Hier laden Sie Ihre Dokumente hoch und unterschreiben Ihre Vollmacht; den Rest übernimmt Ihr Unternehmen.", ar: "{empresa} تتابع ملفك مع {gestoria}. هنا ترفع وثائقك وتوقّع توكيلك؛ والباقي تتولاه شركتك.", ro: "{empresa} îți gestionează dosarul cu {gestoria}. Aici îți încarci documentele și îți semnezi mandatul; de restul se ocupă compania ta.", zh: "{empresa} 正与 {gestoria} 一起为你办理案卷。请在此上传你的文件并签署授权书，其余由公司处理。" },
  "trab.docs.titulo": { es: "Tus documentos", en: "Your documents", fr: "Vos documents", it: "I tuoi documenti", de: "Ihre Dokumente", ar: "وثائقك", ro: "Documentele tale", zh: "你的文件" },
  "trab.docs.intro": { es: "Sube cada documento en su casilla. Tu empresa también puede subirlos por ti.", en: "Upload each document in its slot. Your company can also upload them for you.", fr: "Téléversez chaque document dans sa case. Votre entreprise peut aussi le faire pour vous.", it: "Carica ogni documento nella sua casella. Anche la tua azienda può caricarli per te.", de: "Laden Sie jedes Dokument in sein Feld hoch. Ihr Unternehmen kann das auch für Sie tun.", ar: "ارفع كل وثيقة في خانتها. يمكن لشركتك أيضًا رفعها نيابةً عنك.", ro: "Încarcă fiecare document în căsuța lui. Compania ta le poate încărca și ea pentru tine.", zh: "请将每份文件上传到对应位置。公司也可以代你上传。" },
  "trab.firma.mandatoHint": { es: "Es tu mandato de representación: descárgalo, fírmalo y súbelo aquí.", en: "This is your power of representation: download it, sign it and upload it here.", fr: "C'est votre mandat de représentation : téléchargez-le, signez-le et téléversez-le ici.", it: "È il tuo mandato di rappresentanza: scaricalo, firmalo e caricalo qui.", de: "Das ist Ihre Vollmacht: herunterladen, unterschreiben und hier hochladen.", ar: "هذا توكيلك: حمّله ووقّعه وارفعه هنا.", ro: "Este mandatul tău de reprezentare: descarcă-l, semnează-l și încarcă-l aici.", zh: "这是你的授权书：下载、签署后在此上传。" },
  "trab.listo.titulo": { es: "Documentos enviados", en: "Documents sent", fr: "Documents envoyés", it: "Documenti inviati", de: "Dokumente gesendet", ar: "تم إرسال الوثائق", ro: "Documente trimise", zh: "文件已提交" },
  "trab.listo.texto": { es: "Tu gestoría los revisará. Si falta algo, te avisará. Puedes volver a este enlace cuando quieras para subir más.", en: "Your office will review them. If anything is missing, they'll let you know. You can come back to this link any time to upload more.", fr: "Votre cabinet va les vérifier. S'il manque quelque chose, il vous préviendra. Vous pouvez revenir sur ce lien quand vous voulez pour en ajouter.", it: "Il tuo studio li controllerà. Se manca qualcosa, ti avviserà. Puoi tornare a questo link quando vuoi per caricarne altri.", de: "Ihre Kanzlei prüft sie. Falls etwas fehlt, meldet sie sich. Sie können jederzeit über diesen Link weitere hochladen.", ar: "سيراجعها مكتبك. وإن نقص شيء فسيخبرك. يمكنك العودة إلى هذا الرابط متى شئت لرفع المزيد.", ro: "Biroul tău le va verifica. Dacă lipsește ceva, te va anunța. Poți reveni oricând pe acest link ca să încarci altele.", zh: "你的事务所会进行审核。如有缺漏会通知你。你随时可以通过此链接继续上传。" },
  "trab.invalido": { es: "Este enlace no es válido o ha caducado. Pide a tu empresa o a tu gestoría que te envíen uno nuevo.", en: "This link is invalid or has expired. Ask your company or your office to send you a new one.", fr: "Ce lien n'est pas valide ou a expiré. Demandez à votre entreprise ou à votre cabinet de vous en envoyer un nouveau.", it: "Questo link non è valido o è scaduto. Chiedi alla tua azienda o al tuo studio di inviartene uno nuovo.", de: "Dieser Link ist ungültig oder abgelaufen. Bitten Sie Ihr Unternehmen oder Ihre Kanzlei um einen neuen.", ar: "هذا الرابط غير صالح أو منتهي الصلاحية. اطلب من شركتك أو مكتبك إرسال رابط جديد.", ro: "Acest link nu este valid sau a expirat. Cere companiei sau biroului tău să îți trimită unul nou.", zh: "此链接无效或已过期。请让公司或事务所重新发送。" },
};
