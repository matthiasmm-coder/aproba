...
export const BENEFICIOS: Beneficio[] = [
  ...
  },
  {
    ...
    afirmamos: [
      ...
      { t: "tabla", titulo: "Los 27 modelos EX disponibles", encabezados: ["Modelo", "Trámite", "Modelo", "Trámite"], filas: [
        ["EX-00", "Estancia de larga duración (estudios…)", "EX-18", "Registro / residencia de ciudadano UE"],
        ["EX-01", "Residencia no lucrativa", "EX-19", "Tarjeta de familiar de ciudadano UE"],
        ["EX-02", "Reagrupación familiar", "EX-20", "Documento art. 50 TUE (Reino Unido)"],
        ["EX-03", "Residencia y trabajo por cuenta ajena", "EX-21", "Familiar de británico (art. 50 TUE)"],
        ["EX-04", "Residencia para prácticas", "EX-22", "Trabajador fronterizo del Reino Unido"],
        ["EX-06", "Residencia y trabajo de temporada", "EX-23", "Tarjeta Acuerdo de Retirada (Brexit)"],
        ["EX-07", "Residencia y trabajo por cuenta propia", "EX-24", "Familiar de persona española"],
        ["EX-09", "Residencia con excepción de trabajo", "EX-25", "Menores (residencia / desplazamiento)"],
        ["EX-10", "Arraigo (régimen anterior)", "EX-26", "Modificación de autorización"],
        ["EX-11", "Larga duración", "EX-28", "Disposición transitoria 2ª (RD 1155/2024)"],
        ["EX-13", "Autorización de regreso", "EX-29", "Prórroga de estancia de corta duración"],
        ["EX-15", "NIE y certificados", "EX-31", "Arraigos (RD 1155/2024)"],
  ...
  },
  {
    ...
    significa: [
      ...
      { t: "tabla", titulo: "Las cinco tasas", encabezados: ["Tasa", "Organismo", "Trámites habituales", "Cómo la genera Aproba"], filas: [
        ...
        ["790-006", "Ministerio de Justicia", "Certificado de antecedentes penales (lo pide media extranjería: arraigos, nacionalidad, renovaciones)", "Generada directamente en la sede, con justificante"],
