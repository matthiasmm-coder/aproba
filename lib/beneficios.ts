...
export const BENEFICIOS: Beneficio[] = [
  ...
  },
  {
    ...
    descripcion: "25 modelos EX y las tasas 790-012, 790-052 y 790-026 rellenados con los datos del expediente, editables sobre el impreso oficial. La lista completa.",
    ...
    significa: [
      ...
      { t: "ul", items: [
        ...
        "**Con su tasa.** 790-012 (Policía), 790-052 (Oficinas de Extranjería) o 790-026 (Justicia, nacionalidad), según el trámite ([las 28 piezas](/cifras/28-formularios-y-tasas-oficiales)).",
      ] },
    ],
    afirmamos: [
  ...
  {
    grupo: "cifras", slug: "28-formularios-y-tasas-oficiales",
    tarjeta: "28 formularios y tasas oficiales en un clic",
    titulo: "28 formularios y tasas oficiales en un clic: la lista | Aproba",
    descripcion: "Los 25 modelos EX y las 3 tasas 790 (012, 052, 026) que Aproba genera desde el expediente, uno por uno, y qué trámite corresponde a cada uno.",
    ...
    significa: [
      { t: "datos", items: [
        ...
        { valor: "3", etiqueta: "tasas 790: 012, 052 y 026" },
        { valor: "28", etiqueta: "piezas rellenadas desde el expediente" },
      ] },
      { t: "p", texto: "La lista de los 25 modelos EX, con su trámite, está en la página de [formularios en un clic](/funciones/formularios-en-un-clic). Las tres tasas:" },
      { t: "tabla", titulo: "Las tres tasas de extranjería", encabezados: ["Tasa", "Organismo", "Trámites habituales", "Cómo la genera Aproba"], filas: [
    ...
    afirmamos: [
      { t: "ul", items: [
        "**Cada pieza existe y se puede abrir.** Los 25 PDF oficiales están en la plataforma con su versión vigilada; las tres tasas se generan desde el expediente. En la cuenta de prueba se ven todas en la lista de formularios del expediente de ejemplo.",
