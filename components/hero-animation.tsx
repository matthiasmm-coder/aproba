...
function ExpedientesEnCurso() {
  type Fila = { n: string; ref: string; meta: string; num?: string; ok: [boolean, boolean, boolean, boolean]; who: string; plazo?: string; req?: { plazo: string } };
  const filas: Fila[] = [
    { n: "Julia Mendoza Restrepo", ref: "EXP-2026-0041", meta: "6/6 docs", num: "08/2026/004512", ok: [true, true, true, true], who: "Marta Ribas", req: { plazo: "Quedan 2 días" } },
        ...
        <div className="border-l-2 border-l-aproba-500">
          ...
          {filas.map((f) => (
            ...
            {/* Requerimiento pendiente, a lo ancho de la fila (en la maqueta no cabe junto a
                las casillas): los días que quedan. */}
            {f.req && (
                ...
                <div className="flex h-8 items-center justify-between border-b border-slate-200 bg-cream-50 px-3">
                  ...
                  <div className="flex items-center gap-2.5">
                    <span className="relative text-slate-500">
                      ...
                      <span className="absolute -right-[3px] -top-[3px] flex h-[7px] min-w-[7px] items-center justify-center rounded-full bg-aproba-600 px-[1px] text-[4.5px] font-bold text-white ring-1 ring-cream-50">3</span>
                    </span>
