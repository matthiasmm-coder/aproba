...
function NavIcon({ name }: { name: string }) {
  ...
  if (name === "calendar") return <svg className={c} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2.5" y="4" width="19" height="17.5" rx="2"/><path d="M16 2v4M8 2v4M2.5 10.5h19M12 13.5v5.5M9.25 16.25h5.5"/></svg>;
