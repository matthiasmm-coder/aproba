          ...
          case "esquema": {
            ...
            return (
              <figure key={i} className="my-7 rounded-2xl border border-slate-200 bg-white p-5 sm:p-6">
                ...
                {/* Destino: marco verde claro liso con el panel blanco dentro (13/09/2026; antes un
                    bloque azul oscuro y, un rato, una trama de puntos — Matthias prefirió sin puntos). */}
                <div className="mt-1 rounded-xl border border-aproba-200 bg-aproba-50 p-2.5 text-center sm:mt-2">
