  ...
  return (
    <div id="recepcion" className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5">
      ...
      <ol className="mt-3 grid gap-1.5 text-xs text-slate-600 sm:grid-cols-3">
        ...
        <li className="rounded-lg bg-cream-50 px-3 py-2"><b className="text-slate-800">3.</b> {t("Si no lo reconoce, el email queda en la Bandeja y lo asignas con un clic.")} <Link href="#bandeja" className="font-medium text-aproba-700 underline underline-offset-2">{t("Abrir la bandeja")}</Link></li>
      </ol>
