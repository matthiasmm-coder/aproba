    ...
    <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-6">
      ...
      <div className="mt-3 border-t border-slate-100 pt-3 text-center">
        <p className="mb-2 text-xs text-slate-500">
          {t("Las tasas se generan con los datos de este cliente ya rellenados: la 790-012 en la Sede de la Policía Nacional, la 790-052 (autorizaciones de residencia) y la 790-062 (autorizaciones de trabajo) en la de Administraciones Públicas y la 790-026 (nacionalidad) en la del Ministerio de Justicia.")}
        </p>
