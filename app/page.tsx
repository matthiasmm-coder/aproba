...
const STATS = [
  ...
  { n: "29", l: "formularios y tasas oficiales en un clic", icon: "file", href: rutaDeTarjeta("29 formularios y tasas oficiales en un clic") },
...
const MODULOS = [
  ...
  { titulo: "Formularios en un clic", desc: "25 modelos EX y las tasas 790-012, 790-052, 790-062 y 790-026, rellenados solos y editables. Sin teclear, sin erratas.", icon: "doc" },
