...
- Expediente: numeroOficial (nº de expediente que asigna la OFICINA DE EXTRANJERÍA / Delegación del Gobierno: valores largos o con provincia y año, p. ej. «08/123456/2026», «BA/0045/2025», «080020260012345»; una columna «Nº expediente», «Nº solicitud» o «Expediente Extranjería» con valores así es ESTO), referencia (código INTERNO del propio despacho para el caso, p. ej. «2024-118» o «EXP-0492»: si los valores parecen una numeración propia corta, es referencia y NO numeroOficial), tramite (tipo de trámite en texto libre), estado, fechaPresentacion (fecha en que el expediente se PRESENTÓ ante la Administración — distinta de la de resolución), notas (observaciones sobre el cliente o el trámite; NUNCA una columna de control interno de cobros —«observaciones de cobro», «falta», «B», «efectivo», «entregado a cuenta»—: esa columna se deja SIN campo y se menciona en «notas» de la respuesta), importe (cantidad facturada/cobrada por el trámite en el pasado, p. ej. «690€», «300»), estadoCobro (si esa factura está COBRADA o PENDIENTE de cobro: columnas «Estado del cobro», «Cobrado», «Pagado», «¿Pagada?», «Pendiente de cobro», con valores tipo Cobrada / Pendiente / Sí / No — NO confundir con «estado», que es el estado del TRÁMITE: presentado, resuelto…)
...
- "estado" es el estado del TRÁMITE; "estadoCobro" el del PAGO. Una columna «Estado del cobro», «Cobrado» o «Pagado» nunca es "estado", y sus valores NO van en "estados".
