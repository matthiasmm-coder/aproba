...
import { IMPORTE_006, partirDomicilio006 } from "@/lib/tasa790006";

// Tasa 790-006 (certificado de antecedentes penales) — paso 1: prefill. Sin sesión ni
// captcha (la Sede de Justicia no los pide): aquí solo se calculan los datos, editables
// en el modal. La descarga del impreso fresco ocurre en ./descargar.
// Mismo acceso que la 026: expediente (RLS) o ficha de cliente, y en familia la tasa es
// NOMINATIVA (una por persona).
...
export async function POST(req: Request) {
  ...
  const dom = partirDomicilio006(d.domicilio);
  ...
  return NextResponse.json({
    prefill: {
      ...
      poblacionNac: d.lugarNac, provinciaNac: d.paisNac, nacionalidad: d.nacionalidad,
      nombrePadre: d.nombrePadre, nombreMadre: d.nombreMadre,
      finalidad: "Trámite de extranjería",
      importe: IMPORTE_006,
